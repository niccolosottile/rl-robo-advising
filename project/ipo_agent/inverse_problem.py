...
def inverse_problem(constituents_returns, portfolio_allocations, r_g, M, learning_rate, only_last=False, max_iterations=100):
    ...
    for t in range(1200 + offset, n_time_steps):
        ...
        # Set learning rate
        eta_t = learning_rate / ((t - 1199) ** 0.5) if not only_last else 1
        ...
        for iteration in range(max_iterations):
            ...
            verbose = False #True if iteration == 0 else False
